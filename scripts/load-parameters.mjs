...
export const required = ["APP_ENV","APP_NAME","APP_BASE_URL","APP_AUTH_CALLBACK_URL","SUPABASE_URL","SUPABASE_PROJECT_REF","SUPABASE_AUTH_CALLBACK_URL","THAI_LOCALE","THAI_BUDDHIST_ERA","ENABLE_LINE_LOGIN","ENABLE_GOOGLE_LOGIN","ENABLE_FACEBOOK_LOGIN","ENABLE_APPLE_LOGIN","LOG_LEVEL","ENABLE_DEBUG_TOOLS","CLOUDFLARE_ENV","CLOUDFLARE_WORKER_NAME","EMAIL_PROVIDER","EMAIL_FROM_NAME","EMAIL_FROM_ADDRESS","EMAIL_ENV"];
