...
export const required = ["APP_ENV","APP_NAME","APP_BASE_URL","APP_AUTH_CALLBACK_URL","SUPABASE_URL","SUPABASE_PROJECT_REF","SUPABASE_AUTH_CALLBACK_URL","THAI_LOCALE","THAI_BUDDHIST_ERA","ENABLE_LINE_LOGIN","ENABLE_GOOGLE_LOGIN","ENABLE_FACEBOOK_LOGIN","ENABLE_APPLE_LOGIN","LOG_LEVEL","ENABLE_DEBUG_TOOLS","CLOUDFLARE_ENV"];
...
export function buildEnvironment(p) { return { ...process.env, APP_ENV:p.APP_ENV, APP_URL:p.APP_BASE_URL, LOG_LEVEL:p.LOG_LEVEL, ENABLE_DEBUG_TOOLS:p.ENABLE_DEBUG_TOOLS, NEXT_PUBLIC_APP_ENV:p.APP_ENV, NEXT_PUBLIC_APP_BASE_URL:p.APP_BASE_URL, NEXT_PUBLIC_APP_AUTH_CALLBACK_URL:p.APP_AUTH_CALLBACK_URL, NEXT_PUBLIC_SUPABASE_URL:p.SUPABASE_URL, NEXT_PUBLIC_SUPABASE_PROJECT_REF:p.SUPABASE_PROJECT_REF, NEXT_PUBLIC_THAI_LOCALE:p.THAI_LOCALE, NEXT_PUBLIC_THAI_BUDDHIST_ERA:p.THAI_BUDDHIST_ERA, NEXT_PUBLIC_ENABLE_LINE_LOGIN:p.ENABLE_LINE_LOGIN, NEXT_PUBLIC_ENABLE_GOOGLE_LOGIN:p.ENABLE_GOOGLE_LOGIN, NEXT_PUBLIC_ENABLE_FACEBOOK_LOGIN:p.ENABLE_FACEBOOK_LOGIN, NEXT_PUBLIC_ENABLE_APPLE_LOGIN:p.ENABLE_APPLE_LOGIN }; }
